...
function Record() {
    ...
    useEffect(() => {
        dispatch(recordActions.getAll({ page, type: 0 }) as any)
    }, [page])
    ...
    const scrollToElement = (ref: number) => {
    ...
    return (
        <div className='record container'>
            ...
            <div ref={myRef1} className='section section-2 row'>
                ...
                <LineChart detail type={chartType} />
            ...
            <div ref={myRef3} className='section section-4'>
                ...
                <div className='diaries'>
                    {records?.value?.map((record: any, index: Key | null | undefined) => (
